...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.getHomeListData = undefined;\n\nvar _axios = __webpack_require__(/*! axios */ \"axios\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _constants = __webpack_require__(/*! ./constants */ \"./src/containers/Home/store/constants.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar changeList = function changeList(list) {\n    return {\n        type: _constants.CHANGE_HOME_LIST,\n        list: list\n    };\n};\n\nvar getHomeListData = exports.getHomeListData = function getHomeListData() {\n    return function (dispatch) {\n        return _axios2.default.get('http://47.95.113.63/ssr/api/news.json?secret=M5s2sPneDE').then(function (res) {\n            var data = res.data;\n            var list = res.data.data;\n            dispatch(changeList(list));\n        });\n    };\n};\n\n//# sourceURL=webpack:///./src/containers/Home/store/actions.js?");
